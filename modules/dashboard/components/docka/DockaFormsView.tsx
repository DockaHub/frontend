                ...
                <div className="bg-white dark:bg-zinc-900 border border-docka-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm">
                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody className="divide-y divide-docka-100 dark:divide-zinc-800">
                            {isLoading ? (
                                <tr><td colSpan={7} className="px-6 py-8 text-center text-docka-500">Carregando formulários...</td></tr>
                            ) : forms.length === 0 ? (
                                <tr><td colSpan={7} className="px-6 py-8 text-center text-docka-500">Nenhum formulário criado.</td></tr>
                            ) : forms.map((form) => (
                                <tr key={form.id} className="hover:bg-docka-50 dark:hover:bg-zinc-800/50 transition-colors group">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase border bg-white dark:bg-zinc-900 ${form.org === 'Tokyon' ? 'text-red-600 dark:text-red-400 border-red-200 dark:border-red-900' :
