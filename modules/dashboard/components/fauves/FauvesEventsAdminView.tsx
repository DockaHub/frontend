...
import { AlertOctagon, CalendarDays, ChevronLeft, ChevronRight, Eye, Link as LinkIcon, Loader2, MapPin, MoreHorizontal, PauseCircle, Pin, PlayCircle, Plus, RefreshCw, Save, ShieldAlert, Ticket } from 'lucide-react';
...
import { EventForm } from './EventsView';
...
const FauvesEventsAdminView: React.FC = () => {
    ...
    return <div className="animate-in fade-in duration-500">
        ...
        <Modal isOpen={isCreateOpen} onClose={() => setIsCreateOpen(false)} title="Criar Novo Evento" size="lg">
            <EventForm
